...
task <- read.csv("task.csv", header = TRUE, 
                 stringsAsFactors = FALSE)
task <- task[which(task$id_task == '1207'),]
...
durations <- durations[which(durations$id_task == '1207'),]

ggplot(durations, aes(date_actStart, num_actDur)) + geom_line() +
  scale_x_date() + xlab("") + ylab("1207 Task Duration")
...
data5 <- subset(error5, select = c("desc_frameFam", "num_estimate"))
data5 <- unique(data5[,1:2])

file <- "Duration_Estimate_Tool.xlsx"
...
sheets <- getSheets(wb)
sheet <- sheets[[7]]  # or another
addDataFrame(data5, sheet, col.names = FALSE, row.names = FALSE,
             startRow = 2, startColumn = 1)
saveWorkbook(wb, "1207_Duration_Estimate_Tool.xlsx")

write.csv(error, file = "1207_Duration_Estimate.csv")
write.csv(error2, file = "1207_Duration_Estimate2.csv")
write.csv(error3, file = "1207_Duration_Estimate3.csv")
write.csv(error4, file = "1207_Duration_Estimate4.csv")
write.csv(error5, file = "1207_Duration_Estimate5.csv")
########################################################################
library(data.table)
library(dplyr)
library(ggplot2)
...
estimate1 <- read.csv("1207_Duration_Estimate.csv", header = TRUE, 
                      stringsAsFactors = FALSE)
estimate2 <- read.csv("1207_Duration_Estimate2.csv", header = TRUE, 
                      stringsAsFactors = FALSE)
estimate3 <- read.csv("1207_Duration_Estimate3.csv", header = TRUE, 
                      stringsAsFactors = FALSE)
estimate4 <- read.csv("1207_Duration_Estimate4.csv", header = TRUE, 
                      stringsAsFactors = FALSE)
estimate5 <- read.csv("1207_Duration_Estimate5.csv", header = TRUE, 
                      stringsAsFactors = FALSE)
...
hours <- hours[which(hours$id_task == '1207'),]
...
tasks <- tasks[which(tasks$id_task == '1207'),]
...
addDataFrame(data5, sheet, col.names = FALSE, row.names = FALSE,
             startRow = 2, startColumn = 1)
saveWorkbook(wb, "1207_Hours_Estimate_Tool.xlsx")

write.csv(error, file = "1207_Hours_Estimate.csv")
write.csv(error2, file = "1207_Hours_Estimate2.csv")
write.csv(error3, file = "1207_Hours_Estimate3.csv")
write.csv(error4, file = "1207_Hours_Estimate4.csv")
write.csv(error5, file = "1207_Hours_Estimate5.csv")
...
estimate1 <- read.csv("1207_Hours_Estimate.csv", header = TRUE, 
                      stringsAsFactors = FALSE)
estimate2 <- read.csv("1207_Hours_Estimate2.csv", header = TRUE, 
                      stringsAsFactors = FALSE)
estimate3 <- read.csv("1207_Hours_Estimate3.csv", header = TRUE, 
                      stringsAsFactors = FALSE)
estimate4 <- read.csv("1207_Hours_Estimate4.csv", header = TRUE, 
                      stringsAsFactors = FALSE)
estimate5 <- read.csv("1207_Hours_Estimate5.csv", header = TRUE, 
                      stringsAsFactors = FALSE)
...
file <- "Lead_Time_Estimate_Tool.xlsx"
wb <- loadWorkbook(file)
sheets <- getSheets(wb)
sheet <- sheets[[3]]  # or another
addDataFrame(data, sheet, col.names = FALSE, row.names = FALSE,
...
addDataFrame(data, sheet, col.names = FALSE, row.names = FALSE,
             startRow = 2, startColumn = 2)
saveWorkbook(wb, "1207_Lead_Time_Estimate_Tool.xlsx")



write.csv(error, file = "1207_lead_Estimate.csv")
########################################################################
library(data.table)
library(dplyr)
library(ggplot2)
...
lead <- read.csv("ltData.csv", header = TRUE, 
                 stringsAsFactors = FALSE, na.strings = c(""," ","NA"))
lead <- lead[which(lead$id_task == '1207'),]

lead <- merge(requirements, lead, by="id_tparent")
estimate1 <- read.csv("1207_lead_Estimate.csv", header = TRUE, 
                      stringsAsFactors = FALSE)
#Outcome
estimate1 %>% 
  ggplot(aes(x=num_logError)) + 
